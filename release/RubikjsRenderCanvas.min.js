...
Rubikjs.Render.Canvas.Renderer=function(c){Rubikjs.Render.Renderer.call(this,c);if(void 0!=("canvas"==c.localName?c:void 0))try{this.ctx=c.getContext("2d"),void 0==this.ctx&&alert("No canvas :(")}catch(a){}this.triangles=[]};Rubikjs.Render.Canvas.Renderer.prototype=new Rubikjs.Render.Renderer;Rubikjs.Render.Canvas.Renderer.prototype.constructor=Rubikjs.Render.Canvas.Renderer;Rubikjs.Render.Canvas.Renderer.prototype.startFrame=function(){this.triangles=[]};
...
vec3.subtract([],e,a),vec3.subtract([],f,a))[2]){var g=4*c.indexBuffer.data[b],a={pt0:a,pt1:e,pt2:f,color:[255*c.colorBuffer.data[g]+0.5|0,255*c.colorBuffer.data[g+1]+0.5|0,255*c.colorBuffer.data[g+2]+0.5|0,255*c.colorBuffer.data[g+3]+0.5|0],zmean:0};a.zmean=(a.pt0[2]+a.pt1[2]+a.pt2[2])/3;this.triangles.push(a)}c=0.5*this.element.offsetWidth;a=0.5*this.element.offsetHeight;for(b=0;b<d.length;++b)d[b][0]=(1-d[b][0])*c+0.5|0,d[b][1]=(1-d[b][1])*a+0.5|0};
