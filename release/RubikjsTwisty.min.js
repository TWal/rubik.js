...
Rubikjs.Twisty.FixedPiecePlace.prototype.multipleMove=function(b,a,d){var c=0,e=this,f=function(){c<b?(a.forEach(function(a){a.turnFunction()}),c+=1,setTimeout(f,1E3*(e.turnTime/b)),e.rendermgr.render()):(a.forEach(function(a){a.endFunction()}),d())};f()};Rubikjs.Twisty.FixedPiecePlace.Group=function(b){this.twisty=b;this.pieces=[];this.rotationAxis=[0,1,0];this.rotationCenter=[0,0,0]};
Rubikjs.Twisty.FixedPiecePlace.Group.prototype.cycle=function(b){for(var a=0;a<this.pieces.length;++a)for(var d=this.pieces[a].map(function(a){return a.movable}),c=this.pieces[a].length,e=b%c+c,f=0;f<c;++f)this.pieces[a][f].movable=d[(f+e)%c]};
Rubikjs.Twisty.FixedPiecePlace.Group.prototype.getTurnFunction=function(b,a){b=-b;var d=this.twisty.turnDegree*Math.PI/180*b/a,c=this,e=mat4.rotate(mat4.identity(),d,c.rotationAxis);return{turnFunction:function(){c.pieces.forEach(function(a){a.forEach(function(a){mat4.multiply(e,a.movable.mesh.transform,a.movable.mesh.transform)})})},endFunction:function(){c.cycle(b)}}};
Rubikjs.Twisty.FixedPiecePlace.FullRotation=function(b){this.twisty=b;this.groups=[];this.rotationAxis=[0,1,0];this.rotationCenter=[0,0,0]};Rubikjs.Twisty.FixedPiecePlace.FullRotation.prototype.cycle=function(b){for(var a=0;a<this.groups.length;++a){var d={},c;for(c in this.twisty.groups)this.twisty.groups.hasOwnProperty(c)&&(d[c]=this.twisty.groups[c].pieces);for(var e=this.groups[a].length,f=b%e+e,g=0;g<e;++g)this.twisty.groups[this.groups[a][g]].pieces=d[this.groups[a][(g+f)%e]]}};
Rubikjs.Twisty.FixedPiecePlace.FullRotation.prototype.getTurnFunction=function(b,a){b=-b;var d=this.twisty.turnDegree*Math.PI/180*b/a,c=this,e=mat4.rotate(mat4.identity(),d,c.rotationAxis);return{turnFunction:function(){for(var a in c.twisty.pieces)mat4.multiply(e,c.twisty.pieces[a].movable.mesh.transform,c.twisty.pieces[a].movable.mesh.transform)},endFunction:function(){c.cycle(b)}}};Rubikjs.Twisty.FixedPiecePlace.Combined=function(b,a){this.twisty=b;this.groups=a};
