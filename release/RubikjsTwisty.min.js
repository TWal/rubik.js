...
Rubikjs.Twisty.FixedPiecePlace=function(){this.pieces={};this.groups={};this.turnDegree=90;this.turnTime=0.5;this.stepNumber=10;this.instructionQueue=[];this.isProcessingQueue=!1;this.rendermgr=null};
Rubikjs.Twisty.FixedPiecePlace.prototype.endInit=function(){var a=this,b;for(b in this.groups)this.groups[b]instanceof Rubikjs.Twisty.FixedPiecePlace.Group&&(this.groups[b].pieces=this.groups[b].pieces.map(function(b){return b.map(function(c){return c instanceof Rubikjs.Twisty.FixedPiecePlace.Piece?c:a.pieces[c]})}));this.rendermgr.render()};Rubikjs.Twisty.FixedPiecePlace.prototype.sendInstruction=function(a){this.instructionQueue.push(a);this.processQueue()};
Rubikjs.Twisty.FixedPiecePlace.prototype.sendMultipleInstructions=function(a){this.instructionQueue=this.instructionQueue.concat(a);this.processQueue()};Rubikjs.Twisty.FixedPiecePlace.prototype.stop=function(){this.instructionQueue=[]};
Rubikjs.Twisty.FixedPiecePlace.prototype.processQueue=function(){if(!this.isProcessingQueue)if(0==this.instructionQueue.length)this.isProcessingQueue=!1;else{this.isProcessingQueue=!0;var a=this.instructionQueue[0],b=this,d=function(){b.instructionQueue.shift();b.isProcessingQueue=!1;b.processQueue()};a instanceof Rubikjs.Notation.Move?this.multipleMove(this.stepNumber,[a.group.getTurnFunction(a.count,this.stepNumber)],d):a instanceof Rubikjs.Notation.MultiMove?this.multipleMove(this.stepNumber,a.moves.map(function(c){return c.group.getTurnFunction(c.count*
