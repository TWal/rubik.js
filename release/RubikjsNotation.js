...
Rubikjs.Notation.FullRotation = function(rotName, count) {
    this.rotName = rotName;
    this.count = count;
};

Rubikjs.Notation.FullRotation.prototype = new Rubikjs.Notation.Instruction;
Rubikjs.Notation.FullRotation.prototype.constructor = new Rubikjs.Notation.FullRotation;
