...
Rubikjs.Notation.Instruction=function(){};Rubikjs.Notation.Move=function(a,b){this.group=a;this.count=b};Rubikjs.Notation.Move.prototype=new Rubikjs.Notation.Instruction;Rubikjs.Notation.Move.prototype.constructor=new Rubikjs.Notation.Move;Rubikjs.Notation.Parser=function(){this.separator=" ";this.handleCombined=this.handleParenthesis=!0};
Rubikjs.Notation.Parser.prototype.parse=function(a){var b=this.roughSplit(a);return b[0]==a?"("==a[0]?(b=a.lastIndexOf(")"),console.log(this.getCount(a.substring(b+1))),this.multiplyInstuctions(this.parse(a.substring(1,b)),this.getCount(a.substring(b+1)))):"["==a[0]?(b=a.lastIndexOf("]"),console.log(this.getCount(a.substring(b+1))),this.parse(a.substring(1,b))):this.simpleParse(b[0]):b.map(this.parse,this).reduce(function(a,b){return a.concat(b)})};
...
Rubikjs.Notation.Parser.prototype.combineInstructions=function(a,b){return a};Rubikjs.Notation.Parser.prototype.getCount=function(a){if(""==a)return 1;if("'"==a)return-1;var b=parseInt(a);return"'"==a[a.length-1]?-b:b};Rubikjs.Notation.Parser.prototype.parseToken=function(a){return new Rubikjs.Notation.Instruction};
