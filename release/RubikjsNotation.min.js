...
"[","]"),b=a.indexOf(this.separator,b),b=-1!=b?b:a.length,[a.substring(0,b)].concat(this.roughSplit(a.substring(b)));b=a.length;if(this.handleParenthesis){var c=a.indexOf("(");-1!=c&&c<b&&(b=c)}this.handleCombined&&(c=a.indexOf("{"),-1!=c&&c<b&&(b=c));this.handleCommutators&&(c=a.indexOf("["),-1!=c&&c<b&&(b=c));return[a.substring(0,b)].concat(this.roughSplit(a.substring(b)))};
Rubikjs.Notation.Parser.prototype.findMatching=function(a,b,c,d){d=d||c;for(var e=0,f=1;;){++e;if(1==f&&a[e]==d)return e;a[e]==b?f+=1:a[e]==c&&(f-=1);if(e>=a.length)return-1}};Rubikjs.Notation.Parser.prototype.multiplyInstuctions=function(a,b){if(0>b){a.reverse();for(var c=0;c<a.length;++c)a[c].count=-a[c].count;b=-b}for(var d=[],c=0;c<b;++c)d=d.concat(a);return d};Rubikjs.Notation.Parser.prototype.combineInstructions=function(a,b){return new Rubikjs.Notation.MultiMove(a,b)};
