Rubikjs.WebGL.Buffer=function(a,b,c){this.gl=a;this.type=c||this.gl.ARRAY_BUFFER;this.buffer=this.gl.createBuffer();void 0!=b&&0!=b.length&&this.feed(b)};Rubikjs.WebGL.Buffer.prototype=Rubikjs.Buffer;Rubikjs.WebGL.Buffer.prototype.constructor=Rubikjs.WebGL.Buffer;Rubikjs.WebGL.Buffer.prototype.feed=function(a){this.data=a;this.bind();this.gl.bufferData(this.type,new (this.type==this.gl.ARRAY_BUFFER?Float32Array:Uint16Array)(this.data),this.gl.STATIC_DRAW)};
...
this.perspectiveMat,"mat4")};Rubikjs.WebGL.Renderer.prototype=Rubikjs.Renderer;Rubikjs.WebGL.Renderer.prototype.constructor=Rubikjs.WebGL.Renderer;Rubikjs.WebGL.Renderer.prototype.startFrame=function(){this.gl.clearColor(0,0,0,0);this.gl.clear(this.gl.COLOR_BUFFER_BIT|this.gl.DEPTH_BUFFER_BIT)};
